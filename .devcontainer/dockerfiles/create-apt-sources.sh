...
echo "deb [arch=${ARCH} signed-by=/etc/apt/trusted.gpg.d/openvpn-repo-pkg-key.gpg] https://packages.openvpn.net/openvpn3/debian ${VERSION_CODENAME} main" > "/etc/apt/sources.list.d/openvpn3.list";
